...
namespace AwCon
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "PlayerConfig_Main", menuName = "AwCon/Player/PlayerConfig (Main)")]
    public class PlayerSO : ScriptableObject
    {
        ...
        // Serialized compatibility only. Runtime weapon behaviour uses RangedWeaponSO.AnimationProfile.
        [HideInInspector]
        public ShotgunSO Shotgun;
    }
}
