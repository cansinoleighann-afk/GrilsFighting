    ...
    public class AK46Behaviour : MonoBehaviour, IHoldableItem, IPoolable
    {
        ...
        private void TryFire()
        {
            ...
            if (_akconfig != null && _akconfig.MuzzleVFXPrefab != null && _muzzle != null)
            {
                ...
                {
                    muzzleVFX = AwCon.SimpleObjectPoolSystem.Shared.Spawn(_akconfig.MuzzleVFXPrefab);
            ...
            if (_akconfig != null && _akconfig.ProjectilePrefab != null && _muzzle != null)
            {
                ...
                if (AwCon.SimpleObjectPoolSystem.Shared != null)
                {
                    proj = AwCon.SimpleObjectPoolSystem.Shared.Spawn(_akconfig.ProjectilePrefab);
