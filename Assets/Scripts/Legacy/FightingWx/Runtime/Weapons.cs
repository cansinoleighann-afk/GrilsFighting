...
public class Weapons : MonoBehaviour
{
	...
	public void Throw(int direction, LayerMask hitLayerMask)
	{
		...
		List<Collider> array = DrawHitBox(_throwAttack.CollSize);
		bool flag = false;
	...
	private List<Collider> DrawHitBox(Vector2 CollSize)
	{
		...
		int count = Physics.OverlapBoxNonAlloc(position, new Vector3(1.5f, CollSize.y, CollSize.x / 2f), _hitBoxBuffer, Quaternion.identity, HitLayerMask);
