      ...
      Program "vp"
      {
        SubProgram "gles hw_tier00"
        {
          ...
          void main()
          {
              ...
              u_xlat10_1 = texture2D(_ShineRamp, vs_TEXCOORD1.xy);
              SV_Target0 = u_xlat10_1 * vec4(vec4(_ShineStrength, _ShineStrength, _ShineStrength, _ShineStrength)) + u_xlat0;
              return;
          }
        ...
        SubProgram "gles3 hw_tier00"
        {
          ...
          uniform mediump sampler2D _ShineRamp;
          ...
          void main()
          {
              u_xlat16_0 = texture(_MatCap, vs_TEXCOORD2.xy);
              u_xlat0 = u_xlat16_0 * vec4(vec4(_MatCapStrength, _MatCapStrength, _MatCapStrength, _MatCapStrength));
              u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
              u_xlat0 = u_xlat0 * u_xlat16_1;
              u_xlat0 = u_xlat0 + u_xlat0;
              u_xlat16_1 = texture(_ShineRamp, vs_TEXCOORD1.xy);
              SV_Target0 = u_xlat16_1 * vec4(vec4(_ShineStrength, _ShineStrength, _ShineStrength, _ShineStrength)) + u_xlat0;
              return;
          }
        ...
        SubProgram "gles3 hw_tier00"
        {
          ...
          void main()
          {
              ...
              u_xlat0 = u_xlat0 + u_xlat0;
              u_xlat16_1 = texture(_ShineRamp, vs_TEXCOORD1.xy);
              u_xlat0 = u_xlat16_1 * vec4(vec4(_ShineStrength, _ShineStrength, _ShineStrength, _ShineStrength)) + u_xlat0;
              u_xlat0.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
              SV_Target0.w = u_xlat0.w;
              u_xlat6 = vs_TEXCOORD3;
