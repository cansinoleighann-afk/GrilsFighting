      ...
      Program "vp"
      {
        SubProgram "gles hw_tier00"
        {
          ...
          void main()
          {
              ...
              u_xlat0 = u_xlat16_0 * vec4(_IlumStrength);
              SV_Target0 = u_xlat0;
              return;
          }
        ...
        SubProgram "gles hw_tier00"
        {
          ...
          void main()
          {
              ...
              u_xlat16_1 = u_xlat10_1.wwww * u_xlat10_1;
              u_xlat2.xyz = u_xlat16_1.xyz * vec3(_IlumStrength) + (-unity_FogColor.xyz);
              u_xlat1.w = u_xlat16_1.w * _IlumStrength;
