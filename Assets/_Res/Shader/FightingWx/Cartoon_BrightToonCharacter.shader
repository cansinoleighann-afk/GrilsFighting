Shader "Cartoon/Bright Toon Character"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _SplitCharacterLightDir;
            fixed4 _SplitCharacterLightColor;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float3 l = normalize(_SplitCharacterLightDir.xyz);
                ...
                fixed3 lightColor = albedo.rgb * _LightBrightness * tint * _SplitCharacterLightColor.rgb;
